...
| Assets and themes | Original-inspired default theme, scalable sprites, optional recovered assets | `battletris-client`, `battletris-tools`, `assets/` | Theme switching and scale settings are covered by client adapter tests/build checks; package smoke verifies bundled theme manifests | Original-inspired and high-contrast scalable sprite themes implemented in Phase 13; Phase 18 bundles source-controlled asset manifests |
| Audio | Semantic sound events, generated default sounds, optional recovered pack | `battletris-client::audio`, `battletris-tools`, `assets/` | Client sound-event mapping tests cover line clear and bazaar semantic events; package smoke verifies the generated-default sound-pack manifest | Semantic generated-default/muted sound-pack boundary implemented in Phase 13; Phase 18 bundles the generated-default sound-pack manifest for future audio files |
